...
#   emoji="🌙"
  color=073
  #prompt_segment black default "ddai ${emojis[$RAND_EMOJI_N]}"
  prompt_segment $color 000 "ByPro🌙"
}
...
#     color="#34825A" ## 원하는 색상 입력
    color=030
    prompt_segment $color 015 "$CONDA_DEFAULT_ENV"
    #prompt_segment_custom $color $CURRENT_FG "$BG[160] ${CONDA_DEFAULT_ENV}"
